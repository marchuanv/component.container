...
const namespace = `component.container.property`;
export class Property {
    ...
    */
    constructor(Id, get, set, propertyKey, targetClass, isReadOnly = true) {
        const ref = new Reference(namespace, Property, Id);
